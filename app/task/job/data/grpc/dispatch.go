...
func (c *CometManager) Dispatch(ctx context.Context, message *types.CometMessage) (err error) {
...
func (c *CometManager) DispatchChannels(message *types.CometMessage) (err error) {
...
func (c *CometManager) dispatchRoom(req *v1.DispatchRoomRequest) (err error) {
