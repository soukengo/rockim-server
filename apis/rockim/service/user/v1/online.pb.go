...
func (x *OnlineRefreshRequest) GetUid() string {
	if x != nil {
		return x.Uid
	}
	return ""
...
type OnlineRoomListRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *OnlineRoomListRequest) Reset() {
	*x = OnlineRoomListRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rockim_service_user_v1_online_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *OnlineRoomListRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OnlineRoomListRequest) ProtoMessage() {}

func (x *OnlineRoomListRequest) ProtoReflect() protoreflect.Message {
	mi := &file_rockim_service_user_v1_online_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OnlineRoomListRequest.ProtoReflect.Descriptor instead.
func (*OnlineRoomListRequest) Descriptor() ([]byte, []int) {
	return file_rockim_service_user_v1_online_proto_rawDescGZIP(), []int{6}
}

func (x *OnlineRoomListRequest) GetBase() *service.ServiceRequest {
	if x != nil {
		return x.Base
	}
	return nil
...
func (x *OnlineRoomListRequest) GetUid() string {
	if x != nil {
		return x.Uid
	}
	return ""
...
var file_rockim_service_user_v1_online_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xbd, 0x01, 0x0a, 0x14, 0x4f, 0x6e, 0x6c, 0x69,
	...
	,
	...
	,
	...
	,
...
var file_rockim_service_user_v1_online_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_rockim_service_user_v1_online_proto_goTypes = []interface{}{
	...
	(*OnlineRoomListRequest)(nil),  // 6: rockim.service.user.v1.OnlineRoomListRequest
	(*service.ServiceRequest)(nil), // 7: rockim.service.ServiceRequest
}
var file_rockim_service_user_v1_online_proto_depIdxs = []int32{
	7, // 0: rockim.service.user.v1.OnlineAddRequest.base:type_name -> rockim.service.ServiceRequest
	7, // 1: rockim.service.user.v1.OnlineDeleteRequest.base:type_name -> rockim.service.ServiceRequest
	7, // 2: rockim.service.user.v1.OnlineRefreshRequest.base:type_name -> rockim.service.ServiceRequest
	7, // 3: rockim.service.user.v1.OnlineRoomListRequest.base:type_name -> rockim.service.ServiceRequest
	0, // 4: rockim.service.user.v1.OnlineAPI.Add:input_type -> rockim.service.user.v1.OnlineAddRequest
	2, // 5: rockim.service.user.v1.OnlineAPI.Delete:input_type -> rockim.service.user.v1.OnlineDeleteRequest
	4, // 6: rockim.service.user.v1.OnlineAPI.Refresh:input_type -> rockim.service.user.v1.OnlineRefreshRequest
	1, // 7: rockim.service.user.v1.OnlineAPI.Add:output_type -> rockim.service.user.v1.OnlineAddResponse
	3, // 8: rockim.service.user.v1.OnlineAPI.Delete:output_type -> rockim.service.user.v1.OnlineDeleteResponse
	5, // 9: rockim.service.user.v1.OnlineAPI.Refresh:output_type -> rockim.service.user.v1.OnlineRefreshResponse
...
func file_rockim_service_user_v1_online_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rockim_service_user_v1_online_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OnlineRoomListRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
