...
func (x *AuthRequest) Reset() {
	*x = AuthRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rockim_api_client_v1_socket_client_proto_msgTypes[0]
...
func (*AuthRequest) Descriptor() ([]byte, []int) {
	return file_rockim_api_client_v1_socket_client_proto_rawDescGZIP(), []int{0}
}
...
func (x *AuthResponse) Reset() {
	*x = AuthResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rockim_api_client_v1_socket_client_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AuthResponse) Descriptor() ([]byte, []int) {
	return file_rockim_api_client_v1_socket_client_proto_rawDescGZIP(), []int{1}
}
...
func (x *HeartBeatRequest) Reset() {
	*x = HeartBeatRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rockim_api_client_v1_socket_client_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*HeartBeatRequest) Descriptor() ([]byte, []int) {
	return file_rockim_api_client_v1_socket_client_proto_rawDescGZIP(), []int{2}
}
...
func (x *HeartBeatResponse) Reset() {
	*x = HeartBeatResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rockim_api_client_v1_socket_client_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*HeartBeatResponse) Descriptor() ([]byte, []int) {
	return file_rockim_api_client_v1_socket_client_proto_rawDescGZIP(), []int{3}
}

var File_rockim_api_client_v1_socket_client_proto protoreflect.FileDescriptor

var file_rockim_api_client_v1_socket_client_proto_rawDesc = []byte{
	0x0a, 0x28, 0x72, 0x6f, 0x63, 0x6b, 0x69, 0x6d, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x63, 0x6c, 0x69,
	0x65, 0x6e, 0x74, 0x2f, 0x76, 0x31, 0x2f, 0x73, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x2f, 0x63, 0x6c,
	...
	0x08, 0x02, 0x42, 0x36, 0x5a, 0x34, 0x72, 0x6f, 0x63, 0x6b, 0x69, 0x6d, 0x73, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x2f, 0x61, 0x70, 0x69, 0x73, 0x2f, 0x72, 0x6f, 0x63, 0x6b, 0x69, 0x6d, 0x2f, 0x61,
	0x70, 0x69, 0x2f, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2f, 0x76, 0x31, 0x2f, 0x73, 0x6f, 0x63,
	0x6b, 0x65, 0x74, 0x3b, 0x73, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}

var (
	file_rockim_api_client_v1_socket_client_proto_rawDescOnce sync.Once
	file_rockim_api_client_v1_socket_client_proto_rawDescData = file_rockim_api_client_v1_socket_client_proto_rawDesc
)

func file_rockim_api_client_v1_socket_client_proto_rawDescGZIP() []byte {
	file_rockim_api_client_v1_socket_client_proto_rawDescOnce.Do(func() {
		file_rockim_api_client_v1_socket_client_proto_rawDescData = protoimpl.X.CompressGZIP(file_rockim_api_client_v1_socket_client_proto_rawDescData)
	})
	return file_rockim_api_client_v1_socket_client_proto_rawDescData
}

var file_rockim_api_client_v1_socket_client_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_rockim_api_client_v1_socket_client_proto_goTypes = []interface{}{
...
var file_rockim_api_client_v1_socket_client_proto_depIdxs = []int32{
...
func init() { file_rockim_api_client_v1_socket_client_proto_init() }
func file_rockim_api_client_v1_socket_client_proto_init() {
	if File_rockim_api_client_v1_socket_client_proto != nil {
		return
	}
	file_rockim_api_client_v1_socket_options_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_rockim_api_client_v1_socket_client_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rockim_api_client_v1_socket_client_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rockim_api_client_v1_socket_client_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rockim_api_client_v1_socket_client_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_rockim_api_client_v1_socket_client_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_rockim_api_client_v1_socket_client_proto_goTypes,
		DependencyIndexes: file_rockim_api_client_v1_socket_client_proto_depIdxs,
		MessageInfos:      file_rockim_api_client_v1_socket_client_proto_msgTypes,
	}.Build()
	File_rockim_api_client_v1_socket_client_proto = out.File
	file_rockim_api_client_v1_socket_client_proto_rawDesc = nil
	file_rockim_api_client_v1_socket_client_proto_goTypes = nil
	file_rockim_api_client_v1_socket_client_proto_depIdxs = nil
}
