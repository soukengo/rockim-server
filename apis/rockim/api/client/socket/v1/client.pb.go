...
var file_rockim_api_client_socket_v1_client_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xe4, 0x01, 0x0a, 0x09, 0x43,
	0x6c, 0x69, 0x65, 0x6e, 0x74, 0x41, 0x50, 0x49, 0x12, 0x63, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68,
...
var file_rockim_api_client_socket_v1_client_proto_depIdxs = []int32{
	0, // 0: rockim.api.client.socket.v1.ClientAPI.Auth:input_type -> rockim.api.client.socket.v1.AuthRequest
	2, // 1: rockim.api.client.socket.v1.ClientAPI.HeartBeat:input_type -> rockim.api.client.socket.v1.HeartBeatRequest
	1, // 2: rockim.api.client.socket.v1.ClientAPI.Auth:output_type -> rockim.api.client.socket.v1.AuthResponse
	3, // 3: rockim.api.client.socket.v1.ClientAPI.HeartBeat:output_type -> rockim.api.client.socket.v1.HeartBeatResponse
