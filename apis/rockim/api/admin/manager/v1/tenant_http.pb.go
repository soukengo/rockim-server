...
const OperationTenantAPICreate = "/rockim.api.admin.manager.v1.TenantAPI/Create"
const OperationTenantAPIPaging = "/rockim.api.admin.manager.v1.TenantAPI/Paging"
