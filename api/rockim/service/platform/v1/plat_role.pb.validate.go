...
// Validate checks the field values on PlatRoleResourceIdSaveRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *PlatRoleResourceIdSaveRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on PlatRoleResourceIdSaveRequest with
// the rules defined in the proto definition for this message. If any rules
// are violated, the result is a list of violation errors wrapped in
// PlatRoleResourceIdSaveRequestMultiError, or nil if none found.
func (m *PlatRoleResourceIdSaveRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *PlatRoleResourceIdSaveRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if utf8.RuneCountInString(m.GetRoleId()) < 1 {
		err := PlatRoleResourceIdSaveRequestValidationError{
			field:  "RoleId",
			reason: "value length must be at least 1 runes",
		}
		if !all {
	...
	if len(errors) > 0 {
		return PlatRoleResourceIdSaveRequestMultiError(errors)
	}

	return nil
}

// PlatRoleResourceIdSaveRequestMultiError is an error wrapping multiple
// validation errors returned by PlatRoleResourceIdSaveRequest.ValidateAll()
// if the designated constraints aren't met.
type PlatRoleResourceIdSaveRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m PlatRoleResourceIdSaveRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m PlatRoleResourceIdSaveRequestMultiError) AllErrors() []error { return m }

// PlatRoleResourceIdSaveRequestValidationError is the validation error
// returned by PlatRoleResourceIdSaveRequest.Validate if the designated
// constraints aren't met.
type PlatRoleResourceIdSaveRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e PlatRoleResourceIdSaveRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e PlatRoleResourceIdSaveRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e PlatRoleResourceIdSaveRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e PlatRoleResourceIdSaveRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e PlatRoleResourceIdSaveRequestValidationError) ErrorName() string {
	return "PlatRoleResourceIdSaveRequestValidationError"
}

// Error satisfies the builtin error interface
func (e PlatRoleResourceIdSaveRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sPlatRoleResourceIdSaveRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = PlatRoleResourceIdSaveRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = PlatRoleResourceIdSaveRequestValidationError{}

// Validate checks the field values on PlatRoleResourceIdSaveResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *PlatRoleResourceIdSaveResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on PlatRoleResourceIdSaveResponse with
// the rules defined in the proto definition for this message. If any rules
// are violated, the result is a list of violation errors wrapped in
// PlatRoleResourceIdSaveResponseMultiError, or nil if none found.
func (m *PlatRoleResourceIdSaveResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *PlatRoleResourceIdSaveResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return PlatRoleResourceIdSaveResponseMultiError(errors)
	}

	return nil
}

// PlatRoleResourceIdSaveResponseMultiError is an error wrapping multiple
// validation errors returned by PlatRoleResourceIdSaveResponse.ValidateAll()
// if the designated constraints aren't met.
type PlatRoleResourceIdSaveResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m PlatRoleResourceIdSaveResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m PlatRoleResourceIdSaveResponseMultiError) AllErrors() []error { return m }

// PlatRoleResourceIdSaveResponseValidationError is the validation error
// returned by PlatRoleResourceIdSaveResponse.Validate if the designated
// constraints aren't met.
type PlatRoleResourceIdSaveResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e PlatRoleResourceIdSaveResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e PlatRoleResourceIdSaveResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e PlatRoleResourceIdSaveResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e PlatRoleResourceIdSaveResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e PlatRoleResourceIdSaveResponseValidationError) ErrorName() string {
	return "PlatRoleResourceIdSaveResponseValidationError"
}

// Error satisfies the builtin error interface
func (e PlatRoleResourceIdSaveResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sPlatRoleResourceIdSaveResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = PlatRoleResourceIdSaveResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = PlatRoleResourceIdSaveResponseValidationError{}
