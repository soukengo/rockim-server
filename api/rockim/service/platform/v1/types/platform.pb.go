...
type PlatResource struct {
	...
	// 是否叶子节点
	Leaf string `protobuf:"bytes,10,opt,name=leaf,proto3" json:"leaf,omitempty"`
}
...
func (x *PlatResource) GetLevel() string {
	if x != nil {
		return x.Level
	}
	return ""
...
func (x *PlatResource) GetLeaf() string {
	if x != nil {
		return x.Leaf
	}
	return ""
...
var file_api_rockim_service_platform_v1_types_platform_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0xab, 0x02, 0x0a, 0x0c, 0x50, 0x6c, 0x61, 0x74,
	...
	0x6c, 0x12, 0x12, 0x0a, 0x04, 0x6c, 0x65, 0x61, 0x66, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x04, 0x6c, 0x65, 0x61, 0x66, 0x42, 0x33, 0x5a, 0x31, 0x72, 0x6f, 0x63, 0x6b, 0x69, 0x6d, 0x2f,
