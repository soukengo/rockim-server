...
require (
	...
	github.com/soukengo/gopkg v0.1.7
...
require (
	...
	github.com/go-kratos/kratos/contrib/log/zap/v2 v2.0.0-20230326145430-f03f5f89881f // indirect
	github.com/go-kratos/kratos/contrib/registry/etcd/v2 v2.0.0-20230326145430-f03f5f89881f // indirect
	github.com/go-kratos/kratos/contrib/registry/nacos/v2 v2.0.0-20230326145430-f03f5f89881f // indirect
	github.com/go-kratos/kratos/contrib/registry/zookeeper/v2 v2.0.0-20230326145430-f03f5f89881f // indirect
...
replace github.com/soukengo/gopkg => ../gopkg
